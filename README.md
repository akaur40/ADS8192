...
#> 124     SPAC25H1.03     M2
#> 125    SPCPB1C11.01     M4
#> 126   SPATRNATHR.04     M5
#> 127     SPAC3H8.09c     M3
#> 128      SPBC428.10     M2
#> 129     SPAC977.13c     M3
#> 130     SPCC1494.07     M4
#> 131     SPAC323.07c     M4
#> 132   SPBC16D10.08c     M3
#> 133    SPNCRNA.1571     M2
#> 134      SPBC947.04     M5
#> 135     SPAC1002.20     M2
#> 136      SPCC4E9.02     M4
...
#> 149     SPCC548.06c     M4
#> 150     SPCC1235.14     M4
#> 151   SPBTRNAARG.04     M5
#> 152     SPCC1281.04     M3
#> 153    SPCC1795.12c     M4
#> 154   SPCTRNAGLU.10     M5
#> 155   SPBTRNATHR.07     M5
#> 156      SPAC2F3.08     M2
#> 157     SPBC23E6.09     M4
#> 158       SPBC36.11     M4
#> 159     SPAC1002.18     M3
...
#> 173     SPAC1039.01     M4
#> 174    SPAC26F1.14c     M3
#> 175   SPATRNAVAL.01     M5
#> 176     SPBP4H10.10     M2
#> 177   SPBTRNAGLU.05     M5
#> 178     SPAC11D3.05     M2
#> 179      SPBC215.05     M2
#> 180     SPNCRNA.605     M4
#> 181   SPBP23A10.11c     M4
#> 182    SPAC15A10.13     M4
#> 183     SPNCRNA.607     M3
#> 184      SPCC737.04     M3
#> 185      SPCC4G3.03     M2
#> 186     SPBC17D1.06     M5
#> 187      SPAC4G9.22     M2
#> 188   SPBPB21E7.04c     M3
#> 189   SPCTRNAVAL.11     M5
#> 190    SPBPB21E7.07     M1
#> 191      SPCC18.01c     M4
#> 192   SPCC24B10.08c     M4
#> 193      SPAC1F8.06     M4
#> 194     SPAC56F8.16     M4
#> 195    SPBC17D1.07c     M4
#> 196     SPAC3C7.13c     M2
...
#> 198    SPNCRNA.1278     M4
#> 199    SPBC1289.16c     M3
#> 200   SPCTRNASER.07     M5
#> 201      SPCC965.13     M4
#> 202     SPAC869.07c     M3
#> 203   SPCTRNAGLY.12     M5
#> 204      SPAC3G9.08     M4
#> 205   SPBTRNALEU.08     M5
#> 206     SPBC428.03c     M4
#> 207   SPATRNAPRO.03     M5
#> 208    SPAC29B12.08     M4
#> 209      SPAC3H1.11     M4
#> 210       SPCC63.14     M2
#> 211   SPBTRNAPRO.08     M5
#> 212      SPBC106.10     M2
#> 213    SPBC1861.01c     M4
#> 214   SPAPB24D3.08c     M4
#> 215     SPNCRNA.857     M5
#> 216      SPBC887.17     M5
#> 217      SPCC584.13     M4
#> 218    SPAC6B12.07c     M2
#> 219     SPBC4F6.17c     M3
#> 220   SPCTRNAPRO.09     M5
#> 221   SPAPB18E9.05c     M4
#> 222    SPAC2E1P3.01     M3
#> 223     SPAC17G6.13     M3
#> 224     SPCC1223.13     M4
#> 225   SPBTRNAGLU.08     M5
#> 226     SPAC869.10c     M3
#> 227    SPAC5H10.13c     M4
#> 228     SPNCRNA.756     M5
#> 229     SPAC11E3.14     M2
#> 230     SPBC1711.11     M3
#> 231   SPBTRNAPRO.05     M5
#> 232    SPBC1773.05c     M3
#> 233     SPCC1494.03     M2
#> 234      SPAC343.21     M1
#> 235     SPNCRNA.911     M2
#> 236     SPAC4D7.02c     M3
#> 237   SPAPB24D3.02c     M4
#> 238      SPAC186.01     M4
#> 239     SPACUNK4.19     M2
#> 240      SPCC736.06     M4
#> 241    SPBC1271.07c     M1
...
#> 254    SPAPB1A11.02     M3
#> 255     SPAC14C4.09     M4
#> 256   SPBTRNAASN.03     M5
#> 257   SPBTRNASER.05     M5
#> 258    SPNCRNA.1499     M2
#> 259    SPAC11D3.04c     M1
#> 260      SPAC343.19     M4
#> 261   SPATRNALEU.04     M5
#> 262    SPAC15A10.15     M4
#> 263     SPBC30B4.09     M2
#> 264   SPATRNAVAL.02     M5
#> 265     SPNCRNA.577     M3
#> 266     SPAC25H1.02     M2
#> 267     SPCC594.04c     M2
#> 268   SPBTRNAGLY.05     M5
#> 269    SPAC29E6.10c     M4
#> 270    SPAC26H5.09c     M3
#> 271   SPCTRNAARG.08     M5
#> 272    SPCC1739.11c     M4
#> 273     SPAC11D3.09     M2
#> 274     SPNCRNA.909     M1
#> 275   SPATRNAPHE.02     M5
#> 276   SPCTRNAHIS.04     M5
#> 277     SPCC830.07c     M3
#> 278     SPAC17G6.17     M4
#> 279      SPBC1A4.05     M4
#> 280     SPBPB2B2.01     M1
...
#> 308      SPCC162.12     M4
#> 309    SPAC23C11.01     M4
#> 310   SPCTRNAILE.09     M5
#> 311       SPCC18.08     M4
#> 312    SPNCRNA.1235     M4
#> 313     SPAC212.04c     M3
#> 314   SPCTRNALEU.11     M5
#> 315      SPAC823.03     M2
#> 316    SPBC56F2.05c     M3
#> 317     SPAC1B3.16c     M1
#> 318      SPBC685.03     M4
#> 319    SPNCRNA.1374     M4
#> 320    SPAPB1A10.14     M4
#> 321   SPATRNAGLU.04     M5
#> 322    SPNCRNA.1353     M5
#> 323    SPAC20G4.03c     M3
#> 324    SPAC1399.04c     M3
#> 325    SPCC16A11.08     M2
#> 326   SPBTRNAPHE.03     M5
#> 327    SPBC19C7.04c     M3
#> 328      SPAC140.02     M5
#> 329    SPAC1006.03c     M4
#> 330     SPAC30C2.02     M5
...
#> 353     SPCC162.08c     M4
#> 354      SPAC110.01     M4
#> 355   SPCTRNAGLU.09     M5
#> 356    SPNCRNA.1055     M1
#> 357      SPAC521.03     M3
#> 358      SPBC36.02c     M3
#> 359     SPAC27E2.02     M4
#> 360     SPNCRNA.840     M1
#> 361   SPBTRNAASP.03     M5
#> 362     SPBPB2B2.02     M2
#> 363   SPAPB18E9.02c     M4
#> 364       SPRRNA.06     M5
#> 365     SPAP14E8.02     M4
#> 366      SPAC9E9.02     M1
#> 367     SPBP8B7.16c     M5
...
#> 399    SPNCRNA.1315     M3
#> 400      SPAC3G6.11     M4
#> 401   SPBC29A10.09c     M4
#> 402   SPCTRNAARG.10     M5
#> 403     SPCC188.10c     M4
#> 404    SPAC1250.04c     M4
#> 405      SPBC83.16c     M2
#> 406    SPAC19D5.06c     M4
#> 407   SPAC30D11.04c     M4
#> 408     SPAC27E2.01     M4
#> 409   SPAC12B10.14c     M4
#> 410     SPNCRNA.968     M2
#> 411     SPNCRNA.706     M5
#> 412   SPBTRNAHIS.01     M5
#> 413     SPNCRNA.813     M1
#> 414     SPBC3B8.07c     M3
#> 415    SPCC1840.08c     M4
#> 416       SPBC83.15     M5
...
#> 430    SPBC29B5.02c     M4
#> 431    SPBP23A10.09     M4
#> 432   SPCTRNATHR.08     M5
#> 433     SPBC13A2.03     M4
#> 434     SPCC320.13c     M4
#> 435   SPCTRNASER.09     M5
#> 436     SPAC683.02c     M5
#> 437    SPNCRNA.1371     M1
#> 438     SPCC5E4.10c     M4
#> 439      SPAC9E9.11     M3
...
#> 452    SPAC16E8.06c     M5
#> 453     SPAC1F5.04c     M4
#> 454   SPCTRNAHIS.03     M5
#> 455   SPBTRNAASP.04     M5
#> 456     SPCC553.01c     M4
#> 457    SPBP23A10.13     M4
#> 458    SPBC18H10.05     M3
#> 459    SPAC12B10.03     M4
...
#> 461     SPBC947.11c     M4
#> 462      SPAC9E9.08     M4
#> 463   SPCTRNAASN.05     M5
#> 464   SPBC25D12.03c     M4
#> 465    SPNCRNA.1419     M5
#> 466      SPBC2A9.10     M4
#> 467    SPBC19F5.01c     M3
#> 468    SPCP20C8.02c     M4
#> 469   SPATRNASER.02     M5
#> 470    SPAPB1E7.06c     M4
#> 471     SPCC663.08c     M3
#> 472    SPNCRNA.1599     M4
#> 473      SPBC3B9.01     M3
#> 474    SPCC24B10.15     M4
#> 475   SPBTRNALEU.09     M5
#> 476    SPBC1734.01c     M5
#> 477     SPCC132.04c     M4
#> 478    SPNCRNA.1369     M4
#> 479     SPAC688.02c     M4
...
#> 486     SPAC56F8.09     M5
#> 487      SPBC409.08     M4
#> 488 SPMITTRNAASN.01     M5
#> 489    SPAC56F8.06c     M4
#> 490    SPAPB1A10.05     M3
#> 491      SPAC2F7.04     M4
#> 492      SPBC2A9.02     M3
#> 493   SPBTRNALEU.10     M5
#> 494   SPATRNATHR.05     M5
#> 495    SPNCRNA.1026     M4
#> 496     SPAC7D4.06c     M4
#> 497 SPMITTRNAARG.01     M5
#> 498     SPCC1020.05     M4
#> 499     SPNCRNA.807     M1
#> 500    SPNCRNA.1576     M4
```
